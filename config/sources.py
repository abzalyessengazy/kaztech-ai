...
# ⚠️ Держи хинты специфичными для Казахстана: общие английские слова
# (например "freedom") дают ложные срабатывания на несвязанных статьях
# ("internet freedom" и т.п.), даже с поиском по границе слова.
KAZAKH_RELEVANCE_HINTS = [
    "kazakhstan", "kazakh", "almaty", "astana", "central asia", "astana hub",
    "kaspi", "казахстан", "алматы", "астана", "қазақстан", "tengrinews",
]
